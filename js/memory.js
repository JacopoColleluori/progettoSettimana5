...
let interval = 0;
let varFind = document.querySelector('.find');
let varModal = document.getElementById('modal');
let memoryTimer = 0;
...
function vittoria(){
    ...
    document.querySelector("#tempoTrascorso").innerHTML=formattaData(tempoTimer);
...
function setTimer(){
    tempoTimer=0;
    clearInterval(memoryTimer);
    let varTimer = document.querySelector('.timer');
   
    varTimer.innerHTML = formattaData(tempoTimer);
